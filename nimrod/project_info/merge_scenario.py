...
class MergeScenario:
    ...
    def identify_merge_scenarios(self, merge_information):
        merge_scenarios = []
        commit = Commit(merge_information[0], merge_information[1], merge_information[2], merge_information[3], merge_information[4])#, merge_information[5])#, merge_information[6], merge_information[7])
        return commit
