...
class Randoop_setup:
    ...
    def exec_randoop_for_semantic_conflict_detection(self, evo, scenario, jarBase, jarParentLeft, jarParentRight, jarMerge, commitBaseSha, commitParentLeft, commitParentRight, commitMergeSha):
        conflict_info = []
        try:
    ...
    def exec_randoop_test_conflict(self, evo, scenario, commitBaseSha, commitParentSha, commitMergeSha):
        ...
        try:
            ...
            conflict_info.append(self.behaviour_change.check_conflict_occurrence_for_first_criterion(test_result_base, test_result_parent, test_result_merge, path_suite, commitBaseSha, commitParentSha, commitMergeSha, "randoop"))
    ...
    def generate_and_run_test_suites(self, evo, scenario, commitBaseSha, commitParentTestSuite, commitOtherParent, commitMergeSha, conflict_info):
        try:
            ...
            conflict_info.append(self.behaviour_change.check_conflict_occurrence_for_first_criterion(test_result_base, test_result_parent_test_suite, test_result_merge, path_suite, commitBaseSha, commitParentTestSuite, commitMergeSha, "randoop"))
            conflict_info.append(self.behaviour_change.check_conflict_occurrence_for_second_criterion(test_result_base, test_result_parent_test_suite, test_result_other_parent, test_result_merge, path_suite, commitBaseSha, commitParentTestSuite, commitOtherParent, commitMergeSha, "randoop"))
