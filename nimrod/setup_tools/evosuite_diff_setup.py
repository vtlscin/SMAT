...
class Evosuite_Diff_setup:
    ...
    def exec_evosuite_jar_test_conflict_second_criteria(self, evo, scenario, jarBase, jarParentLeft, jarParentRight, jarMerge, commitBaseSha, commitParentLeft, commitParentRight, commitMergeSha):
        ...
        try:
            ...
            self.exec_evosuite_test_conflict_second(evo, scenario, commitBaseSha, commitParentLeft, commitParentLeft, commitMergeSha, conflict_info)
        except:
            print("Some project versions could not be evaluated")
    ...
    def exec_evosuite_diff_test_conflict(self, evo, scenario, commitBaseSha, commitParentSha, commitMergeSha):
        ...
        try:
            ...
            conflict_info.append(self.behaviour_change.check_different_test_results_for_merge_scenario(test_result_base, test_result_parent, test_result_merge, path_suite, commitBaseSha, commitParentSha, commitMergeSha, "differential-evosuite"))
    ...
    #def exec_evosuite_test_conflict_second(self, evo, scenario, commitBaseSha, commitParentLeft, commitParentRight, commitMergeSha, conflict_info):
    def exec_evosuite_test_conflict_second(self, evo, scenario, commitBaseSha, commitParentTestSuite, commitOtherParent, commitMergeSha, conflict_info):
        try:
            ...
            conflict_info.append(self.behaviour_change.check_different_test_results_for_merge_scenario(test_result_base, test_result_parent_test_suite, test_result_merge, path_suite, commitBaseSha, commitParentTestSuite, commitMergeSha, "differential-evosuite"))
            conflict_info.append(self.behaviour_change.check_different_test_results_for_merge_scenario_second_criterion(test_result_base, test_result_parent_test_suite, test_result_other_parent, test_result_merge, path_suite, commitBaseSha, commitParentTestSuite, commitOtherParent, commitMergeSha, "differential-evosuite"))
