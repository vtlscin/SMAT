        ...
        for row in csv_reader:
            if row[1] == "true":
                ...
                for i in range(0, 1):
                    ...
                    randoop = semantic_study_obj.randoop_setup.run_tool_for_commit(semantic_study_obj, merge, row[13], row[2], Tools.RANDOOP.value)
                    randoop_modified = semantic_study_obj.randoop_modified_setup.run_tool_for_commit(semantic_study_obj, merge, row[13], row[2], Tools.RANDOOP_MOD.value)
                    coverage_report.generate_report(semantic_study_obj, merge, row[2], randoop, randoop_modified, row[0])
                    randoop = semantic_study_obj.randoop_setup.run_tool_for_commit(semantic_study_obj, merge, row[11], row[3], Tools.RANDOOP.value)
                    randoop_modified = semantic_study_obj.randoop_modified_setup.run_tool_for_commit(semantic_study_obj, merge, row[11], row[3], Tools.RANDOOP_MOD.value)
                    coverage_report.generate_report(semantic_study_obj, merge, row[3], randoop, randoop_modified, row[0])
                    randoop = semantic_study_obj.randoop_setup.run_tool_for_commit(semantic_study_obj, merge, row[12], row[4], Tools.RANDOOP.value)
                    randoop_modified = semantic_study_obj.randoop_modified_setup.run_tool_for_commit(semantic_study_obj, merge, row[12], row[4], Tools.RANDOOP_MOD.value)
                    coverage_report.generate_report(semantic_study_obj, merge, row[4], randoop, randoop_modified, row[0])
                    randoop = semantic_study_obj.randoop_setup.run_tool_for_commit(semantic_study_obj, merge, row[10], row[5], Tools.RANDOOP.value)
                    randoop_modified = semantic_study_obj.randoop_modified_setup.run_tool_for_commit(semantic_study_obj, merge, row[10], row[5], Tools.RANDOOP_MOD.value)
                    coverage_report.generate_report(semantic_study_obj, merge, row[5], randoop, randoop_modified, row[0])