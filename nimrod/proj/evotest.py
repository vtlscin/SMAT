...
class evotest:
    ...
    def __init__(self):
        self.classes_dir = '$(find /media/jprm/Ubuntu/IC/example-project-evosuite/base/target/dependency/ | paste -sd ":")":/media/jprm/Ubuntu/IC/example-project-evosuite/base/target/classes/"'
        self.sut_class = "br.com.Ball"
        self.dRegCp = '$(find /media/jprm/Ubuntu/IC/example-project-evosuite/left/target/dependency/ | paste -sd ":")":/media/jprm/Ubuntu/IC/example-project-evosuite/left/target/classes"'
    ...
    def gen_evosuite_diff(self):
        evosuite = Evosuite(
            ...
            tests_src="/media/jprm/Ubuntu/IC/nimrod-hunor/nimrod/proj/evosuite-tests"
        )
...
if __name__ == '__main__':
    ...
    #print(evo.java)
    a =subprocess.check_output(['java', '-jar', '/media/jprm/Ubuntu/IC/nimrod-hunor/nimrod/tools/bin/evosuite-1.0.6.jar'])
    print(a)
